...
start "BAI Backend Server - Port 8001" cmd /k "cd /d %~dp0 && echo Backend server starting... && echo Current directory: %CD% && uv run python -m uvicorn app.main:app --reload --port 8001 --host 0.0.0.0"
