...
start "BAI Backend Server - Port 8001" cmd /k "cd /d %~dp0backend && .venv\Scripts\activate.bat && echo Backend server starting... && python -m uvicorn app.main:app --reload --port 8001 --host 0.0.0.0"
